    ...
    <div className="tpl-page" style={{ background: '#f3f2f1' }}>
      <div className="tpl-container" style={{ maxWidth: 560 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24 }}>
          ...
          <span style={{ fontSize: 18, fontWeight: 600, color: '#1b1b1b' }}>MeetSpace</span>
        </div>
        ...
        <div className="tpl-card">
          {f.state === 'idle' && (
            <>
              ...
              <p className="tpl-text">You have been invited to a meeting. Please verify your identity to accept the invitation and join.</p>
          ...
          {(f.state === 'code_ready' || f.state === 'waiting') && (
            <>
              ...
              <div className="tpl-steps"><div className="tpl-step">1. Copy the verification code</div><div className="tpl-step">2. Click verify and enter the code</div></div>
